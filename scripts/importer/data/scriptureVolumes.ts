...
export const NEW_TESTAMENT: VolumeConfig = {
	...
	books: [
		...
		// Paul's Epistles
		{
			id: "rom",
			name: "Romans",
			fullName: "The Epistle of Paul to the Romans",
			chapters: 16,
			category: "epistles-paul",
		},
		{
			id: "1-cor",
			name: "1 Corinthians",
			fullName: "The First Epistle of Paul to the Corinthians",
			chapters: 16,
			category: "epistles-paul",
		},
		{
			id: "2-cor",
			name: "2 Corinthians",
			fullName: "The Second Epistle of Paul to the Corinthians",
			chapters: 13,
			category: "epistles-paul",
		},
		{
			id: "gal",
			name: "Galatians",
			fullName: "The Epistle of Paul to the Galatians",
			chapters: 6,
			category: "epistles-paul",
		},
		{
			id: "eph",
			name: "Ephesians",
			fullName: "The Epistle of Paul to the Ephesians",
			chapters: 6,
			category: "epistles-paul",
		},
		{
			id: "philip",
			name: "Philippians",
			fullName: "The Epistle of Paul to the Philippians",
			chapters: 4,
			category: "epistles-paul",
		},
		{
			id: "col",
			name: "Colossians",
			fullName: "The Epistle of Paul to the Colossians",
			chapters: 4,
			category: "epistles-paul",
		},
		{
			...
			fullName: "The First Epistle of Paul to the Thessalonians",
			chapters: 5,
			category: "epistles-paul",
		},
		{
			...
			fullName: "The Second Epistle of Paul to the Thessalonians",
			chapters: 3,
			category: "epistles-paul",
		},
		{
			id: "1-tim",
			name: "1 Timothy",
			fullName: "The First Epistle of Paul to Timothy",
			chapters: 6,
			category: "epistles-paul",
		},
		{
			id: "2-tim",
			name: "2 Timothy",
			fullName: "The Second Epistle of Paul to Timothy",
			chapters: 4,
			category: "epistles-paul",
		},
		{
			id: "titus",
			name: "Titus",
			fullName: "The Epistle of Paul to Titus",
			chapters: 3,
			category: "epistles-paul",
		},
		{
			id: "philem",
			name: "Philemon",
			fullName: "The Epistle of Paul to Philemon",
			chapters: 1,
			category: "epistles-paul",
		},
		...
		// General Epistles
		{
			id: "heb",
			name: "Hebrews",
			fullName: "The Epistle to the Hebrews",
			chapters: 13,
			category: "epistles-general",
		},
		{
			id: "james",
			name: "James",
		...
		},
		{
			id: "2-pet",
			name: "2 Peter",
			fullName: "The Second Epistle General of Peter",
			chapters: 3,
			category: "epistles-general",
		},
		{
		...
		},
		{
			id: "2-jn",
			name: "2 John",
			fullName: "The Second Epistle of John",
			chapters: 1,
			category: "epistles-general",
		},
		{
			id: "3-jn",
			name: "3 John",
			fullName: "The Third Epistle of John",
			chapters: 1,
			category: "epistles-general",
		},
		{
		...
		// Apocalyptic
		{
			id: "rev",
			name: "Revelation",
			fullName: "The Revelation of John",
			chapters: 22,
	...
	books: [
		{
			id: "dc",
			name: "Doctrine and Covenants",
			fullName: "The Doctrine and Covenants",
			chapters: 138,
			category: "modern-revelation",
		},
	],
};
